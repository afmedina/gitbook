...
> **Tutorial AnyLogic: Simulação Baseada em Agentes** / Afonso C. Medina _et al._ — 1. ed. — São Paulo: Genoa Soluções, 2026.
>
> Modo de acesso: World Wide Web.
>
> ISBN: _(a atribuir)_
>
> 1. Simulação computacional. 2. Modelagem baseada em agentes. 3. AnyLogic. 4. Pesquisa Operacional. I. Medina, Afonso C. II. Título.

Terceiro volume da série de tutoriais de AnyLogic em português, ao lado de _Modelagem de Processos_ (eventos discretos) e _Dinâmica de Sistemas_.

***

_© Genoa Soluções. Este material pode ser usado livremente para fins educacionais, com atribuição._
